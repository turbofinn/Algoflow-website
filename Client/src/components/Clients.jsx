...
const logos = [
  { id: 1, src: '/images/drdo.avif', alt: 'DRDO Logo', name: 'DRDO', since: '2019' },
  { id: 2, src: '/images/ntpc.svg', alt: 'NTPC Logo', name: 'NTPC', since: '2020' },
  { id: 3, src: '/images/parkey.png', alt: 'Parkkey Logo', name: 'Parkkey India', since: '2021' },
  { id: 4, src: '/images/idylll2.webp', alt: 'Idylll Logo', name: 'Idylll Restaurants', since: '2020' },
  { id: 5, src: '/images/turbo.png', alt: 'TurboTreats Logo', name: 'TurboTreats RMS', since: '2022' },
  { id: 6, src: '/images/bishop.png', alt: 'Bishops Logo', name: 'Bishops Waltham', since: '2021' },
];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            {logos.map((logo, index) => (
              ...
              >
                ...
                >
                  {/* Verified badge with trophy icon */}
                  <motion.div 
                    className="absolute -top-3 -right-3 bg-gradient-to-br from-[#4ed35e] to-[#1b6f08] text-white p-2 rounded-full z-10"
                  ...
                  <motion.div 
                    className="absolute inset-0 bg-gradient-to-br from-[#4ed35e]/5 to-[#1b6f08]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  />
