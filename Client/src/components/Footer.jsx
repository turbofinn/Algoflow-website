      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            />
            {/* <span className="ml-2 text-emerald-500 font-semibold">100</span> */}

          </div>

          {/* Links */}
          <div>
            <h3 className="text-lg font-semibold mb-6 text-black">Links</h3>
            <ul className="space-y-4">
              {["About Us", "Services", "Case Studies", "How it works", "Blog", "Careers", "Areas We Serve"].map(
                (item) => (
                  <li key={item}>
          ...
          <div>
            ...
            <p className="text-gray-900 font-medium">+923183561921</p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-600 text-sm">© 2023 Copyright by IK Developers. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
